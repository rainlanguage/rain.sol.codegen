...
/// @title IParserToolingV1NoticeTest
/// @notice `IParserToolingV1` is published and consumed as an ABI artifact, so
...
contract IParserToolingV1NoticeTest is Test {
    /// The interface whose emitted NatSpec is asserted here.
    string internal constant CONTRACT_NAME = "IParserToolingV1";

    /// The source file the compiler wrote that interface's artifact for.
    string internal constant SOURCE_FILE_NAME = "IParserToolingV1.sol";
