...
/// @title IIntegrityToolingV1NoticeTest
/// @notice `IIntegrityToolingV1` is published and consumed as an ABI artifact,
...
contract IIntegrityToolingV1NoticeTest is Test {
    /// The interface whose emitted NatSpec is asserted here.
    string internal constant CONTRACT_NAME = "IIntegrityToolingV1";

    /// The source file the compiler wrote that interface's artifact for.
    string internal constant SOURCE_FILE_NAME = "IIntegrityToolingV1.sol";
